...
// RF Freq.(MHz): 434.00313    API_TC: 29    fhst: 6250    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 1    Hi_pfm_div: 1    
// 
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x38, 0x0E, 0xEF, 0xC9, 0x01, 0xB5, 0x20, 0xFE
